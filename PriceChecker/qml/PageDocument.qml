...
Page {
    ...
    function resetItem(itemRef){
        wsClient.documentTableResetData(itemRef, wsDocumentTable)
    }
        ...
        ListViewControl {
            ...
            onMenuTriggered: function(row, command, object, comment){
                ...
                if(command === "mnuOpen"){
                    ...
                    pageDoc.openMarkedTable(pageDoc.rowObject.ref, item_ref, item_representation, item_quantity)
                }
            }
        }
