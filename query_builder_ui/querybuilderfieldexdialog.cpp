...
#include "ui_querybuilderfieldexdialog.h"
...
QueryBuilderFieldExDialog::QueryBuilderFieldExDialog(QWidget *parent, const QUuid& packade_uuid) :
    QDialog(parent),
...
void QueryBuilderFieldExDialog::set_database_structure(ITree<ibase_object_structure> *structurte)
{
