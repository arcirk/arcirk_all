...
namespace arcirk::tree_widget {
    ...
    public:
        ...
        QMap<QString, tree_editor_inner_role> inner_roles() const;
    ...
    private:
        ...
        tree_editor_inner_role widgetInnerRole(const QString& key);
    ...
    private slots:
        ...
        void onInnerRoleChanged(int row, int column, const tree_editor_inner_role& value);
