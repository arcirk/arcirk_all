        ...
        void create_controls(){
            ...
            for (auto itr = obj.items().begin(); itr != obj.items().end(); ++itr) {
                ...
                if(it.value().is_number())
                    set_user_role_data(it.key().c_str(), arcirk::tree::user_role::WidgetRole, arcirk::tree::item_editor_widget_roles::widgetSpinBoxRole);
                else if(it.value().is_boolean())
                    set_user_role_data(it.key().c_str(), arcirk::tree::user_role::WidgetRole, arcirk::tree::item_editor_widget_roles::widgetCheckBoxRole);
                else if(it.value().is_string())
                    set_user_role_data(it.key().c_str(), arcirk::tree::user_role::WidgetRole, arcirk::tree::item_editor_widget_roles::widgetTextLineRole);
                else if(it.value().is_array())
                    set_user_role_data(it.key().c_str(), arcirk::tree::user_role::WidgetRole, arcirk::tree::item_editor_widget_roles::widgetVariantRole);
